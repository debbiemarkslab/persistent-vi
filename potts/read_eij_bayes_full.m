function params = read_eij_bayes_full(paramfile)
...
%
params.logScaleH_mu = fread(f_eij, [1 1], PRECISION)';
params.logScaleH_std = fread(f_eij, [1 1], PRECISION)';
params.logScaleE_mu = fread(f_eij, [1 1], PRECISION)';
params.logScaleE_std = fread(f_eij, [1 1], PRECISION)';
%
